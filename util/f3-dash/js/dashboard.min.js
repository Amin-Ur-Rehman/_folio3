...
angular.module('RDash').provider('$f3Actions', ['$stateProvider', function F3ActionsProvider($stateProvider) {
    ...
    this.add = function(key, obj) {
        ...
        $stateProvider.state('actions.' + key, obj);
...
angular.module("RDash").config(['$f3ActionsProvider', function ($f3ActionsProvider) {


    $f3ActionsProvider.add('view-scrub', {
        title: 'View Scrub',
        action: function() {
    ...
    $f3ActionsProvider.add('search-orders', {
        title: 'Search Orders',
        action: function() {
    ...
    $f3ActionsProvider.add('search-customers', {
        ...
        controllerAs: 'searchCustomersCtrl',
        title: 'Search Customers'
    });


    $f3ActionsProvider.add('execute-so-sync-script', {
        url: "/execute-so-sync-script",
        templateUrl: f3_base_url + "/f3-dash/templates/actions-execute-so-sync-script.html",
        controller: 'ExecuteSoSyncScriptCtrl',
        controllerAs: 'executeSoSyncScriptCtrl',
        title: 'Execute SO Sync Script'
    });

}]);


angular.module("RDash").config(["$stateProvider", "$urlRouterProvider", '$f3ActionsProvider', function ($stateProvider, $urlRouterProvider, $f3ActionsProvider) {

    $urlRouterProvider.otherwise("/");

    console.log('$f3ActionsProvider2: ', $f3ActionsProvider);
    ...
    $stateProvider
        ...
        .state("actions", {
            url: "/actions",
            templateUrl: f3_base_url + "/f3-dash/templates/actions.html",
...
angular.module("RDash").controller("ExecuteSoSyncScriptCtrl", ExecuteSoSyncScriptCtrl);
angular.module("RDash").controller("SearchCustomersCtrl", SearchCustomersCtrl);
angular.module("RDash").controller("SearchMagentoOrdersCtrl", SearchMagentoOrdersCtrl);
angular.module("RDash").controller("ActionsCtrl", ActionsCtrl);


function SearchCustomersCtrl($stateParams){
    console.log('SearchCustomersCtrl');
}

function ExecuteSoSyncScriptCtrl($stateParams){
    console.log('ExecuteSoSyncScriptCtrl');
}

function SearchMagentoOrdersCtrl($stateParams) {
    console.log('SearchMagentoOrdersCtrl');
}

function ActionsCtrl ($f3Actions, $state) {
