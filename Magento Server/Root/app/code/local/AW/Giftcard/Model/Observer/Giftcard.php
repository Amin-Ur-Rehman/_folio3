...
class AW_Giftcard_Model_Observer_Giftcard extends Mage_Core_Model_Abstract
{
    ...
    public function salesOrderSaveAfter(Varien_Event_Observer $observer)
    {
        ...
        foreach ($order->getAllItems() as $item) {
            ...
            //Mage::log('options: ' . json_encode($options), null, 'gc-f3.log', true);
            $options->aw_gc_created_codes = array("700000");
            ...
            if (count($createdCodesArray) > 0 && $item->getProductOptionByCode('aw_gc_recipient_email')) {
                ...
                try {
                    ...
                    //Mage::log('Before prepareEmailAndSend', null, 'gc-f3.log', true);
                    $emailTemplate->prepareEmailAndSend($_templateData, $store);
                    //Mage::log('After prepareEmailAndSend', null, 'gc-f3.log', true);
